...
<body class="bg-biru-m">
    ...
    <div class="main-content">
        ...
        <div class="menu-container">
            <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="menu-item-card" data-category="<?php echo e($item->category); ?>">
                    <div class="menu-image"></div>
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <p class="menu-name"><?php echo e($item->name); ?></p>
                            <p class="menu-price">Rp <?php echo e(number_format($item->price, 0, ',', '.')); ?></p>
                        </div>
    ...
    <div class="right-sidebar">
        ...
        <a href="<?php echo e(route('order-confirmation')); ?>" class="continue-btn w-100 mt-4">Continue to Payment</a>
    </div>
...
<?php /**PATH C:\laragon\www\uasweb\resources\views/menu/index.blade.php ENDPATH**/ ?>